            ...
            <Grid container spacing={3} justify="center">
                <Grid item component={Card} className={cx(styles.card, styles.infected)} xs={12} md={3}>
                    <CardContent>
                        ...
                        <Typography variant='body2'>The current number of active COVID-19 cases.</Typography>
                    </CardContent>
                </Grid>
                <Grid item component={Card} className={cx(styles.card, styles.recovered)} xs={12} md={3}>
                    <CardContent>
                        ...
                        <Typography color='textSecondary'>{new Date(lastUpdate).toDateString()}</Typography><br/>
                        <Typography variant='body2'>The number of people who have recovered from COVID-19.</Typography>
                    </CardContent>
                </Grid>
                <Grid item component={Card} className={cx(styles.card, styles.deaths)} xs={12} md={3}>
                    <CardContent>
                        ...
                        <Typography color='textSecondary'>{new Date(lastUpdate).toDateString()}</Typography><br/>
                        <Typography variant='body2'>The number of people who have died from COVID-19.</Typography>
                    </CardContent>
                </Grid>
            </Grid>
        </div>
